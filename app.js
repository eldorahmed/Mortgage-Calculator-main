const defaultText = document.getElementById("initial-text");
const calculationsContainer = document.getElementById("result-container");
...
document.getElementById("compute-button").addEventListener("click", () => {
  ...
  document.querySelectorAll(".flex-input").forEach((el) => {
